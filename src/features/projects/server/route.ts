...
const app = new Hono()
   ...
   .get('/:projectId/analytics', sessionMiddleware, async (c) => {
      ...
      const lastMonthEnd = startOfMonth(subMonths(now, 1));
      ...
      const incompelteTaskDifference =
      ...
      const compeltedTasksDifference =
      ...
      return c.json({
         data: {
            ...
            completedTasksCount,
            compeltedTasksDifference,
            incompletedTaskCount,
            incompelteTaskDifference,
            overdueTasksCount,
